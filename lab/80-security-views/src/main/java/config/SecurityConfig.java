...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		// - Log in using an incorrect user/password such as 'foo' and 'foo'.
		...
		http
		    ...
		    // - Log in as user 'viewer' and you should now be able to access the
	...
	public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
		...
		// - Recompile this class and let the web application restart.
		// - If you don't see the login form, log out from the application
